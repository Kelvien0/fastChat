...
import 'package:fast_chat/Logics/functions.dart';
import 'package:fast_chat/chatpage.dart';
...
class _MyHomePageState extends State<MyHomePage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      backgroundColor: Color.fromRGBO(27, 166, 142, 1),
      appBar: AppBar(
        backgroundColor: Color.fromRGBO(27, 166, 142, 1),
        title: const Text('Fast Chat'),
        elevation: 0,
        centerTitle: true,
        actions: [
          Padding(
            ...
            Column(
              ...
              children: [
                Container(
                  ...
                  child: Container(
                    color:Color.fromRGBO(27, 166, 142, 1),
                    ...
                    child: Column(
                      ...
                      children: [
                        Padding(
                          ...
                          child: Text(
                            'Contacts',
                            style: Styles.h1().copyWith(color: Color.fromRGBO(27, 166, 142, 1)),
                          ),
                        ),
                        Expanded(
                          child: Padding(
