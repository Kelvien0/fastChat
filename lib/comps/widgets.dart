...
import 'package:fast_chat/comps/animated-dialog.dart';
import 'package:fast_chat/comps/styles.dart';
...
class ChatWidgets {
  ...
  static drawer(context) {
    return Drawer(
      backgroundColor: /*Colors.purple.shade400,*/Color.fromRGBO(27, 166, 142, 1),
      child: SafeArea(
        child: Padding(
